 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 40, -0.7}
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (X_MIN_POS + 40) // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT (Y_MIN_POS + 40)  // Y point for Z homing
#endif
